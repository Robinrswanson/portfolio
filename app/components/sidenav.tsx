  ...
  return (
    <div className="hidden sm:flex flex-col items-center justify-center text-white">
      <div className="flex flex-col items-center space-y-4">
        <Link href="https://github.com/robinrswanson" className="transition duration-300 ease-in-out hover:scale-125" passHref>
        ...
        <Link href="https://www.linkedin.com/in/robinrswanson" className="transition duration-300 ease-in-out hover:scale-125" passHref>
        <svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" viewBox="0 0 24 24">
